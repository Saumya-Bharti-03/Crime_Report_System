    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="ufir.jsp">Add FIR</a>
          <a class="dropdown-item" href="uviewfir.jsp">View FIR</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="cc.jsp">Crime Category List<span class="sr-only">(current)</span></a>
      </li>
    </ul>
      <a class="btn btn-light my-2 my-sm-0 mr-2" type="submit" href="#" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-user" aria-hidden="true"></i> Welcome <%=session.getAttribute("fname")%> (user)</a>
